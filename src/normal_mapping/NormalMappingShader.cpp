...
static const char *VERTEX_FILE = "data/shaders/normalMapVShader.glsl";
static const char *FRAGMENT_FILE = "data/shaders/normalMapFShader.glsl";

NormalMappingShader::NormalMappingShader()
        : ShaderGL("NormalMapped", VERTEX_FILE, FRAGMENT_FILE)
{
    BindAttributes();
    Link();
    GetUniformLocations();
