...
struct ImFont
{
    ...
    IMGUI_API void              AddRemapChar(ImWchar dst, ImWchar src, bool overwrite_dst = true); // Makes 'dst' character/glyph points to 'nanosvg' character/glyph. Currently needs to be called AFTER fonts have been built.
